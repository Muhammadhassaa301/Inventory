        ...
        <div class="modal-content">
            ...
            <div class="modal-body pb-5 px-sm-5 pt-50">
                <div class="text-center mb-2">
                    <h1 class="mb-1">Add: title, descriptoin, amount</h1>
                </div>
                    <form id="add-department-form" class="row gy-1 pt-75" action="{{ route('invoice.productitem.history.addhistory') }}" method="POST">
                       @csrf
                       <div>{{ $productitem->id }}</div>
                       <input type="hidden" name="product_item_id" value="{{ $productitem->id }}">
                {{-- <form id="add-department-form" class="row gy-1 pt-75" action=""> --}}
                    <div class="col-12">
                    ...
                    <div class="col-12">
                        <label class="form-label" for="modalAddTitle">Description</label>
                    ...
                    <div class="col-12">
                        <label class="form-label" for="modalAddTitle">Amount</label>
                        <input type="number" id="modalAddAmount" name="amount" class="form-control" placeholder="Amount" autocomplete="off" required />
                        <div class="text-danger d-none"></div>
                    </div>

                    <div class="col-12 text-center mt-2 pt-50">
                        <button type="submit" class="btn btn-primary me-1" id="create_department">Create</button>
