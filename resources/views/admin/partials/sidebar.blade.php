...
{{--                    </li>--}}
{{--                    <li class=""><a class="d-flex align-items-center" href="dashboard-ecommerce.html"><i data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="eCommerce">eCommerce</span></a>--}}
{{--                    </li>--}}
{{--                </ul>--}}
{{--            </li>--}}
            <li class=" navigation-header"><span data-i18n="Apps &amp; Pages">Products</span>
            </li>
            <li class=" nav-item {{ navActive(route('product.list')) }}"><a class="d-flex align-items-center" href="{{route('product.list')}}"><i data-feather="server"></i><span class="menu-title text-truncate" data-i18n="List">List</span></a>
            </li>
            <li class=" nav-item {{ navActive(route('brand.list')) }}"><a class="d-flex align-items-center" href="{{route('brand.list')}}"><i data-feather="server"></i><span class="menu-title text-truncate" data-i18n="Brands">Brands</span></a>
            </li>
            <li class=" navigation-header"><span data-i18n="Apps &amp; Pages">Invoices</span>
            </li>
            <li class=" nav-item {{ navActive(route('invoice.list')) }}"><a class="d-flex align-items-center" href="{{route('invoice.list')}}"><i data-feather="server"></i><span class="menu-title text-truncate" data-i18n="List">List</span></a>
            </li>
            <li class=" nav-item {{ navActive(route('vendor.list')) }}"><a class="d-flex align-items-center" href="{{route('vendor.list')}}"><i data-feather="server"></i><span class="menu-title text-truncate" data-i18n="Vendors">Vendors</span></a>
            </li>
            <li class=" navigation-header"><span data-i18n="Apps &amp; Pages">System</span>
            </li>
...
{{--            </li>--}}
            ...
            <li class=" nav-item {{ navActive(route('admin.department.list')) }}"><a class="d-flex align-items-center" href="{{route('admin.department.list')}}"><i data-feather="server"></i><span class="menu-title text-truncate" data-i18n="Departments">Departments</span></a>
            </li>
            <li class=" nav-item"><a class="d-flex align-items-center" href="#"><i data-feather="shield"></i><span class="menu-title text-truncate" data-i18n="Roles &amp; Permission">Roles &amp; Permission</span></a>
                <ul class="menu-content">
                    <li class="{{ navActive(route('admin.role.list')) }}"><a class="d-flex align-items-center" href="{{route('admin.role.list')}}"><i data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="Roles">Roles</span></a>
                    </li>
                    <li class="{{ navActive(route('admin.permission.list')) }}"><a class="d-flex align-items-center" href="{{ route('admin.permission.list') }}"><i data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="Permission">Permission</span></a>
                    </li>
                </ul>
            </li>
...
{{--                </ul>--}}
{{--            </li>--}}
            <li class=" nav-item {{ navActive(route('admin.user.list')) }}"><a class="d-flex align-items-center" href="{{ route('admin.user.list') }}"><i data-feather="user"></i><span class="menu-title text-truncate" data-i18n="User">Users</span></a>
{{--                <ul class="menu-content">--}}
