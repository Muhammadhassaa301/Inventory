...
@section('content')
                        ...
                        <tbody>
                            @foreach ($pmh as $v)
                                <tr>
                                    ...
                                    {{-- javascript:void(0) --}}
                                    {{-- {{ route('invoice.productitem.edit', 1) }} --}}
                                    ...
                                    <td>
                                        ...
                                        @can('product_item.delete')
                                            <a class="delete_history"
                                                href="{{ route('invoice.productitem.history.deletehistory', $v->id) }}"><i
    ...
    @include('admin.invoices.productitems.history.modals.add')
    @include('admin.invoices.productitems.history.modals.edit')
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#editProductItemHistoryModal').on('show.bs.modal', function(e) { // View Single Department
                ...
                var htm = '<div class="text-center"><div class="spinner-border" role="status"> <span class="visually-hidden">Loading...</span></div></div>';

                $this.find('.edit_history').html(htm);

                var route = '{{ route('invoice.productitem.history.edithistory', ':history_id') }}';
