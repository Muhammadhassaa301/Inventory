                                        ...
                                        <div class="d-flex align-items-center justify-content-md-end mb-1">
                                            ...
                                            <div class="input-group input-group-merge invoice-edit-input-group">
                                                ...
                                                <input type="text" class="form-control invoice-edit-input"
                                                    placeholder="53634"  value="{{$invoice->invoice_no}}" />
                                            </div>
                                        </div>
                                                    ...
                                                    <div class="row w-100 pe-lg-0 pe-1 py-2 product_div">
                                                        <div class="col-lg-5 col-12 mb-lg-0 mb-2 mt-lg-0 mt-2">
                                                            ...
                                                            <select class="form-select item-details select_product"
                                                                ...
                                                                @foreach ($products as $product)
                                                                    ...
                                                                    {{$product->id == $item->product->id ? 'selected' : '' }}
                                                        ...
                                                        <div class="col-lg-2 col-12 my-lg-0 my-2">
                                                            ...
                                                            <input type="number" class="form-control product_QTY"
                                                                placeholder="1" name="quantity" value="{{$invoice->quantity}}" />
                                                        </div>
                                                        ...
                                                        <div class="col-lg-2 col-12 my-lg-0 my-2">
                                                            ...
                                                            <input type="number" class="form-control product_price"
                                                                value="{{$invoice->amount}}" placeholder="1" name="product_price" 
                                                                data-rate />
                                                        </div>
                                    ...
                                    <div class="col-md-6 d-flex justify-content-end order-md-2 order-1">
                                        <div class="invoice-total-wrapper">
                                            <div class="invoice-total-item">
                                                ...
                                                <p class="invoice-total-amount wqSubTotal">PKR{{$invoice->amount}}</p>
                                            </div>
                                            {{-- <div class="invoice-total-item">
